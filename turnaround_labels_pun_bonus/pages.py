...
class PunishBucketHigh(Page):

    def is_displayed(self):
        return self.round_number == (Constants.num_roundsr / 2 + 1) and self.participant.vars['condition'] == \
               'Punish' and self.participant.vars['bucket'] == "High"
    pass


class BonusBucketLow(Page):

    def is_displayed(self):
        return self.round_number == (Constants.num_roundsr / 2 + 1) and self.participant.vars['condition'] == \
               'Bonus' and self.participant.vars['bucket'] == "Low"
...
class PunishVote(Page):
    ...
    def is_displayed(self):
        return self.round_number > (Constants.num_roundsr / 2) and self.participant.vars['condition'] == 'Punish'
    pass
