# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2020-01-29 14:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='turnaround_labelst_group', to='otree.Session')),
            ],
            options={
                'db_table': 'turnaround_labelst_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='turnaround_labelst.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='turnaround_labelst_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='turnaround_labelst_player', to='otree.Session')),
            ],
            options={
                'db_table': 'turnaround_labelst_player',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='turnaround_labelst_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'turnaround_labelst_subsession',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.AddField(
            model_name='player',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turnaround_labelst.Subsession'),
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
